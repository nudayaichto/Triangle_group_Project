...
template <class T>
Right_Tr<T>::Right_Tr() : Triangle<T>(3, 4, 5) {}

template <class T>
Right_Tr<T>::Right_Tr(T leg1, T leg2) : Triangle<T>(leg1, leg2, static_cast<T>(sqrt(leg1* leg1 + leg2 * leg2))) {
    if (!isRightTriangle()) {
...
template <class T>
bool Right_Tr<T>::isRightTriangle() const {
    T A = this->a;
    T B = this->b;
    T C = this->c;
...
template <class T>
void Right_Tr<T>::change_sides(T Side1, T Side2) {
    int choice;
    T newLeg1 = Side1;
    T newLeg2 = Side2;
    T newA, newB, newC;
...
template <class T>
double Right_Tr<T>::in_circle(T qwe) const {
    if (!isRightTriangle()) throw invalid_argument("Triangle is not equilateral");
    T a = this->a;
    T b = this->b;
    T c = this->c;
...
template <class T>
double Right_Tr<T>::out_circle(T qwe) const {
    if (!isRightTriangle()) throw invalid_argument("Triangle is not equilateral");
    T c = this->c;
    return c / 2;
}
